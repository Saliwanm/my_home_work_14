...
step 3) Open input_file.txt and write several email addresses (which we will divide into domain parts) in each line 1
step 4) Open main.py and run application
step 5) Open output_file and copy all information ctrl+c
step 6) Open this site: regex101.com
